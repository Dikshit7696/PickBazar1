    ...
    return (
        <div>
            ...
            <div className='bg-gray-200 py-32'>
                <h1 className='pt-20 text-3xl font-sans font-bold text-center'>Terms & Conditions</h1>
                <div className='flex justify-self-center mt-4'>
                    ...
                    <p className='text-gray-500'><IoIosArrowForward className='inline mx-4' />Terms & Condtions</p>
                </div>
            </div>
