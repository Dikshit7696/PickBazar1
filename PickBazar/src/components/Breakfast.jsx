...
function Breakfast() {
    ...
    const [activeDropdown, setActiveDropdown] = useState('breakfast');
                    ...
                    <div className='mt-6 mx-10'>
                        <div className='grid grid-cols-4 gap-4'>
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F350%2FEveryday_Essentials_Wholemeal_Bread.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Everyday Essentials Meal Bread</h1>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F351%2FFarmhouse_Multigrain_Batch_loaf_purple_pack.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Farmhouse Multigrain Batch Loaf</h1>
                                    <p className='font-thin text-sm mt-2'>1lb</p>
                                    <div className='flex'>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F352%2Froberts_Seriously_Seeded_Bloomer.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Roberts Seeded Bloomer</h1>
                                    <p className='font-thin text-sm mt-2'>1lb</p>
                                    <div className='flex'>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F353%2Fthe_village_bakery_danish_low_fat.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>The Village Bakery Low Fat Bread</h1>
                                    <p className='font-thin text-sm mt-2'>1lb</p>
                                    <div className='flex'>
                                        <p className='font-semibold text-green-500 mt-12'>$3.00</p>
                                        <button className='ml-28 mt-11 font-semibold rounded-3xl border border-green-500 w-24 h-9 text-green-500 hover:bg-green-700 hover:text-white'><MdOutlineShoppingBasket className='inline mr-3 h-4 w-4' />Cart</button>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F354%2Fthe_village_bakery_danish_Soft_White_Toastie.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>The Village Bakery Soft White Bread</h1>
                                    <p className='font-thin text-sm mt-2'>1lb</p>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F355%2Fthe_village_bakery_Soft_Wholemeal_Bread.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>The Village Bakery Soft Meal Bread</h1>
                                    <p className='font-thin text-sm mt-2'>1lb</p>
                                    <div className='flex'>
                                        <p className='font-semibold text-green-500 mt-12'>$3.00</p>
                                        <button className='ml-28 mt-11 font-semibold rounded-3xl border border-green-500 w-24 h-9 text-green-500 hover:bg-green-700 hover:text-white'><MdOutlineShoppingBasket className='inline mr-3 h-4 w-4' />Cart</button>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F356%2FWarburtons_Wholemeal_mild_soft.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Warburtons Wholemeal Bread</h1>
                                    <p className='font-thin text-sm mt-2'>1lb</p>
                                    <div className='flex'>
                                        <p className='font-semibold text-green-500 mt-12'>$4.00</p>
                                        <button className='ml-28 mt-11 font-semibold rounded-3xl border border-green-500 w-24 h-9 text-green-500 hover:bg-green-700 hover:text-white'><MdOutlineShoppingBasket className='inline mr-3 h-4 w-4' />Cart</button>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F357%2Ffibre1_crunchy_original.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Fibre 1 Crunchy Original</h1>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F358%2Fgeneral_mills_with_whole_grain_first_ingredient_trix_wildberry_red_swirls.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Trix</h1>
                                    <p className='font-thin text-sm mt-2'>1 pc(s)</p>
                                    <p className='font-thin text-sm mt-6 italic line-through'>$4.00</p>
                                    <div className='flex'>
                                        <p className='font-semibold text-green-500 mt-2'>$3.25</p>
                                        <button className='ml-28 font-semibold rounded-3xl border border-green-500 w-24 h-9 text-green-500 hover:bg-green-700 hover:text-white'><MdOutlineShoppingBasket className='inline mr-3 h-4 w-4' />Cart</button>
                                    </div>
                                </div>
                            </div>
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F359%2Fgeneral_mills_with_whole_grain_guaranted_fiber_one_honey_clusters.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Fibre One</h1>
                                    <p className='font-thin text-sm mt-2'>1 pc(s)</p>
                                    <p className='font-thin text-sm mt-6 italic line-through'>$4.00</p>
                                    <div className='flex'>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F360%2Fnestle_made_with_whole_grain_corn_flakes.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Nestle Corn Flakes</h1>
                                    <p className='font-thin text-sm mt-2'>1 pc(s)</p>
                                    <div className='flex'>
                                        <p className='font-semibold text-green-500 mt-12'>$4.00</p>
                                        <button className='ml-28 mt-11 font-semibold rounded-3xl border border-green-500 w-24 h-9 text-green-500 hover:bg-green-700 hover:text-white'><MdOutlineShoppingBasket className='inline mr-3 h-4 w-4' />Cart</button>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F361%2Fpost_honey_comb_cereal_12.5oz.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Post Honey Comb</h1>
                                    <p className='font-thin text-sm mt-2'>1 pc(s)</p>
                                    <div className='flex'>
                                        <p className='font-semibold text-green-500 mt-12'>$4.00</p>
                                        <button className='ml-28 mt-11 font-semibold rounded-3xl border border-green-500 w-24 h-9 text-green-500 hover:bg-green-700 hover:text-white'><MdOutlineShoppingBasket className='inline mr-3 h-4 w-4' />Cart</button>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F364%2Fchivers_mixed_fruit_jam.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Chivers Mixed Fruit Jam</h1>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F365%2Fred_jacket_raspberry_jam.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Red Jacket Raspberry Jam</h1>
                                    <p className='font-thin text-sm mt-2'>2lb</p>
                                    <div className='flex'>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md mb-10'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F366%2FGin_Jam.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center' alt="" />
                                <div className='text-start ml-5'>
                                    <h1 className='font-semibold'>Gin Jam</h1>
                                    <p className='font-thin text-sm mt-2'>2lb</p>
                                    <p className='font-thin text-sm mt-6 italic line-through'>$6.00</p>
                                    <div className='flex'>
