...
function Vegetables() {
    ...
    const [activeDropdown, setActiveDropdown] = useState('fruits');
                        ...
                        <ul className="space-y-6 sticky top-32 left-0">
                            ...
                            {activeDropdown === 'fruits' && (
                                <ul className="space-y-4 mr-10 mt-1">
                                    <li className="hover:text-green-500 cursor-pointer mr-8"><Link className='nav-link' to='/fruits' onClick={(e) => e.stopPropagation()}>Fruits</Link></li>
                                    <li className="hover:text-green-500 cursor-pointer"><Link className='nav-link' to='/vegetables' onClick={(e) => e.stopPropagation()}>Vegetables</Link></li>
                                </ul>
                            )}
