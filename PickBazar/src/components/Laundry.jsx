                ...
                <div className="w-full bg-gray-100  flex relative z-1">
                    ...
                    <div className='mt-6 mx-10'>
                        <div className='grid grid-cols-4 gap-4'>
                            ...
                            <div className='h-[400px] w-72 bg-white border rounded-md'>
                                <img src="https://pickbazar-react.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F301%2Flaundry_products_purex.jpg&w=1920&q=75" className='w-60 h-60 justify-self-center object-contain' alt="" />
                                <div className='text-start ml-5'>
